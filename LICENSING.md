...
A `LICENSE-planka` file may sit beside this one. That is the original's licence text
...
This is a clean-room implementation of [plankanban/planka](https://github.com/plankanban/planka), Copyright
the plankanban/planka authors, licensed under the terms in LICENSE.md. It was written against a specification derived
by running that system and recording what it does, not by translating its source. See
`../planka-port/specs/SPEC-001-planka.md` for the rules it was built to, and `ACKNOWLEDGEMENTS.md` for any text carried
across and why.
